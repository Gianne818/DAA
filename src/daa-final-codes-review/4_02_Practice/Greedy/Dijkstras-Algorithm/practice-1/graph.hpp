// COMMENT THESE OUTS, ONLY THESE 5 FUNCTIONS NEEDED
...
class Graph {
   public:
    ...
    virtual bool insertVertex(int x) = 0;
    virtual bool insertEdge(int u, int v, int x) = 0;
    // virtual int removeVertex(char v) = 0;
    // virtual bool removeEdge(int e) = 0;
    virtual int distance(int u, int v) = 0;
    virtual int dijkstra(int u, int v) = 0;
